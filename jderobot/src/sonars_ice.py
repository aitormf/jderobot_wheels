...
if 'SonarsData' not in _M_jderobot.__dict__:
    ...
    _M_jderobot.SonarsDataPrx = Ice.createTempClass()
    class SonarsDataPrx(Ice.ObjectPrx):

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_jderobot.SonarsDataPrx.ice_checkedCast(proxy, '::jderobot::SonarsData', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)

        def uncheckedCast(proxy, facet=None):
            return _M_jderobot.SonarsDataPrx.ice_uncheckedCast(proxy, facet)
    ...
    _M_jderobot._t_SonarsDataPrx = IcePy.defineProxy('::jderobot::SonarsData', SonarsDataPrx)

    _M_jderobot._t_SonarsData = IcePy.defineClass('::jderobot::SonarsData', SonarsData, -1, (), False, False, None, (), (
    ...
    _M_jderobot.SonarsDataPrx = SonarsDataPrx
    del SonarsDataPrx

if 'Sonars' not in _M_jderobot.__dict__:
    _M_jderobot.Sonars = Ice.createTempClass()
    class Sonars(Ice.Object):
        """Interface to the Gazebo sonars sensor."""
        def __init__(self):
            if Ice.getType(self) == _M_jderobot.Sonars:
                raise RuntimeError('jderobot.Sonars is an abstract class')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_Sonars)
    ...
    class SonarsPrx(Ice.ObjectPrx):
        ...
        def getSonarsData(self, _ctx=None):
            return _M_jderobot.Sonars._op_getSonarsData.invoke(self, ((), _ctx))

        def begin_getSonarsData(self, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_jderobot.Sonars._op_getSonarsData.begin(self, ((), _response, _ex, _sent, _ctx))

        def end_getSonarsData(self, _r):
            return _M_jderobot.Sonars._op_getSonarsData.end(self, _r)

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_jderobot.SonarsPrx.ice_checkedCast(proxy, '::jderobot::Sonars', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)
    ...
    _M_jderobot._t_Sonars = IcePy.defineClass('::jderobot::Sonars', Sonars, -1, (), True, False, None, (), ())
    Sonars._ice_type = _M_jderobot._t_Sonars
