...
if 'GenericData' not in _M_jderobot.__dict__:
    _M_jderobot.GenericData = Ice.createTempClass()
    class GenericData(Ice.Object):
        """Static description of the image source.
        Members:
        name -- < %The name of the file
        format -- < % The format of the file
        data -- < % The file data itself"""
        def __init__(self, name='', format='', data=None):
            self.name = name
            self.format = format
            self.data = data

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::jderobot::GenericData')

        def ice_id(self, current=None):
            return '::jderobot::GenericData'
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_GenericData)

        __repr__ = __str__

    _M_jderobot.GenericDataPrx = Ice.createTempClass()
    class GenericDataPrx(Ice.ObjectPrx):

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_jderobot.GenericDataPrx.ice_checkedCast(proxy, '::jderobot::GenericData', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)

        def uncheckedCast(proxy, facet=None):
            return _M_jderobot.GenericDataPrx.ice_uncheckedCast(proxy, facet)
    ...
    _M_jderobot._t_GenericDataPrx = IcePy.defineProxy('::jderobot::GenericData', GenericDataPrx)

    _M_jderobot._t_GenericData = IcePy.defineClass('::jderobot::GenericData', GenericData, -1, (), False, False, None, (), (
        ('name', (), IcePy._t_string, False, 0),
        ('format', (), IcePy._t_string, False, 0),
        ('data', (), _M_jderobot._t_ByteSeq, False, 0)
    ))
    GenericData._ice_type = _M_jderobot._t_GenericData

    _M_jderobot.GenericData = GenericData
    del GenericData

    _M_jderobot.GenericDataPrx = GenericDataPrx
    del GenericDataPrx

if 'genericDataProvider' not in _M_jderobot.__dict__:
    _M_jderobot.genericDataProvider = Ice.createTempClass()
    class genericDataProvider(Ice.Object):
        def __init__(self):
            if Ice.getType(self) == _M_jderobot.genericDataProvider:
                raise RuntimeError('jderobot.genericDataProvider is an abstract class')

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::jderobot::genericDataProvider')

        def ice_id(self, current=None):
            return '::jderobot::genericDataProvider'

        def ice_staticId():
            return '::jderobot::genericDataProvider'
        ice_staticId = staticmethod(ice_staticId)

        def getGenericData(self, current=None):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_genericDataProvider)

        __repr__ = __str__

    _M_jderobot.genericDataProviderPrx = Ice.createTempClass()
    class genericDataProviderPrx(Ice.ObjectPrx):

        """Returns the generic data class
        Arguments:
        _ctx -- The request context for the invocation."""
        def getGenericData(self, _ctx=None):
            return _M_jderobot.genericDataProvider._op_getGenericData.invoke(self, ((), _ctx))
        ...
        def begin_getGenericData(self, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_jderobot.genericDataProvider._op_getGenericData.begin(self, ((), _response, _ex, _sent, _ctx))

        """Returns the generic data class
        Arguments:"""
        def end_getGenericData(self, _r):
            return _M_jderobot.genericDataProvider._op_getGenericData.end(self, _r)

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_jderobot.genericDataProviderPrx.ice_checkedCast(proxy, '::jderobot::genericDataProvider', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)

        def uncheckedCast(proxy, facet=None):
            return _M_jderobot.genericDataProviderPrx.ice_uncheckedCast(proxy, facet)
        uncheckedCast = staticmethod(uncheckedCast)
    ...
    _M_jderobot._t_genericDataProviderPrx = IcePy.defineProxy('::jderobot::genericDataProvider', genericDataProviderPrx)

    _M_jderobot._t_genericDataProvider = IcePy.defineClass('::jderobot::genericDataProvider', genericDataProvider, -1, (), True, False, None, (), ())
    genericDataProvider._ice_type = _M_jderobot._t_genericDataProvider

    genericDataProvider._op_getGenericData = IcePy.Operation('getGenericData', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), _M_jderobot._t_GenericData, False, 0), ())

    _M_jderobot.genericDataProvider = genericDataProvider
    del genericDataProvider

    _M_jderobot.genericDataProviderPrx = genericDataProviderPrx
    del genericDataProviderPrx
